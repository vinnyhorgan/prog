...
Qualora abbiate delle rimostranze al riguardo, le potete fare; nel qual caso sarete interrogati su: (a) GNU Coding Standards, (b) Google Coding Standards e (c) Node/NPM/Javascript Coding standards, etc. etc. etc.

L'editor consigliato (non fosse altro perché è tuttora quello con le migliori procedure di indentazione automatica del codice) è, ça va sans dire, Emacs (e derivati)