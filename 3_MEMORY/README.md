**Argomenti**: Attributi di una variabile; Binding: il concetto di binding, binding time, storage binding, lifetime. Scoping: sottoprogrammi e record di attivazione, scoping statico e dinamico. Passaggio di parametri a sottoprogrammi. Controlli di tipo; Tipizzazione statica, dinamica, implicita ed esplicita; conversioni ed inferenza di tipo; tipizzazione forte, debole; linguaggi type safe ed unsafe; equivalenza e compatibilità tra tipi; esempi di type system.

**Riferimenti**: Sebesta, 5.1-5.8, 6, 9.4, 9.5, 10.1, 10.2
